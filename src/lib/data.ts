...
export const projects: Project[] = [
  {
    ...
    gallery: [
      ...
      "/visual-proof/ppmechanical/seo-page.webp",
  ...
  },
  {
    ...
    gallery: [
      ...
      "/visual-proof/speedwaymotors/trade-in.webp",
      "/visual-proof/speedwaymotors/stats.webp",
      "/visual-proof/speedwaymotors/map.webp",
      "/visual-proof/speedwaymotors/dealership-story.webp",
      "/visual-proof/speedwaymotors/trust-section.webp",
      "/visual-proof/speedwaymotors/seo-newark-nj.webp",
      "/visual-proof/speedwaymotors/seo-clifton-nj.webp",
      "/visual-proof/speedwaymotors/pagespeed.webp",
      "/visual-proof/speedwaymotors/client-message.webp",
  ...
  },
  {
    ...
    gallery: [
      ...
      "/visual-proof/tweak-os/lead-search.webp",
      "/visual-proof/tweak-os/crm-pipeline.webp",
      "/visual-proof/tweak-os/automation-setting.webp",
      "/visual-proof/tweak-os/login-screen.webp",
      "/visual-proof/tweak-os/proposal-generator.webp",
      "/visual-proof/tweak-os/proposal-result.webp",
    ],
  ...
  },
  {
    ...
    gallery: [
      ...
      "/visual-proof/jerseypantry/cart.webp",
      "/visual-proof/jerseypantry/checkout.webp",
    ],
