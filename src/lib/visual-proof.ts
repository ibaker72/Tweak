...
export const visualProofProjects: VisualProofProject[] = [
  {
    ...
    media: [
      ...
      { src: `${PP_BASE}/why-us.webp`, type: "image", label: "Why us" },
      ...
      { src: `${PP_BASE}/footer.webp`, type: "image", label: "Footer" },
  ...
  },
  {
    ...
    media: [
      ...
      { src: `${TWEAK_BASE}/discover.webp`, type: "image", label: "Discover leads" },
