...
const pricingTabs: PricingTab[] = [
  ...
  },
  {
    ...
    description:
      "For startups and teams building portals, dashboards, internal tools, SaaS products, or custom systems.",
  },
];
...
const studioPricingTiers: StudioTier[] = [
  {
    ...
    audience: "Custom website projects for service businesses",
  ...
  },
  {
    ...
    audience: "Monthly growth support for businesses",
    price: "Starting at $1,500/mo",
    priceNote: "Monthly growth support for businesses that want more traffic and better conversion.",
    summary:
      "For businesses that already have a site and want ongoing SEO, content direction, and conversion improvements.",
    features: [
  ...
  },
  {
    ...
    audience: "Custom scoped project",
    price: "Starting at $12,000",
    priceNote: "Custom scoped project",
    summary:
      "For teams that need custom software, integrations, internal systems, or more advanced product work.",
    features: [
  ...
  },
  {
    ...
    audience: "Fixed-scope product builds",
