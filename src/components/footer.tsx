...
export function FAQ() {
  ...
  return (
    <section id="faq" className="relative py-28 sm:py-36">
      <div className="relative mx-auto max-w-[800px] px-6 sm:px-8">
        <Reveal>
          <div className="mb-16 text-center sm:mb-20">
            <span className="section-label">FAQ</span>
            <h2 className="mt-5 font-display text-[clamp(32px,4.5vw,52px)] font-extrabold leading-[1.04] tracking-[-0.04em] text-white">Common questions</h2>
          ...
          {faqs.map((faq, i) => (
            <Reveal key={i} delay={i * 0.03}>
              <div className={cn(
                ...
                open === i ? "border-accent/[0.15] bg-accent/[0.02]" : "border-white/[0.05] bg-white/[0.012]"
              )}>
                <button suppressHydrationWarning onClick={() => setOpen(open === i ? null : i)} className="flex w-full items-center justify-between gap-4 px-6 py-5 text-left sm:px-7">
                ...
                <div className="overflow-hidden transition-[max-height] duration-300" style={{ maxHeight: open === i ? 300 : 0 }}>
                  <p className="px-6 pb-6 text-[14px] leading-[1.8] text-body sm:px-7">{faq.a}</p>
                </div>
              </div>
            </Reveal>
          ))}
...
export function Footer() {
  const cols = [
    { h: "Services", links: [{ l: "Web Applications", href: "/#services" }, { l: "Landing Pages", href: "/#services" }, { l: "E-Commerce", href: "/#services" }, { l: "Automation & AI", href: "/#services" }, { l: "Digital Marketing", href: "/services/digital-marketing" }] },
    ...
    { h: "Resources", links: [{ l: "Blog", href: "/blog" }, { l: "Cost Calculator", href: "/tools/website-cost-calculator" }, { l: "Resources", href: "/resources" }, { l: "Compare", href: "/compare/tweak-and-build-vs-freelancer" }, { l: "North Jersey SEO", href: "/seo" }] },
  ];
