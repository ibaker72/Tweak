              ...
              <Link href={`/work/${p.slug}`} className="card group flex h-full flex-col">
                ...
                <div className="flex flex-1 flex-col p-6">
                  <div className="flex items-center gap-2">
                    ...
                    {!p.live && p.slug === "voltgrid" && <span className="rounded-md border border-amber-400/[0.2] bg-amber-400/[0.06] px-2 py-0.5 text-[9px] font-bold text-amber-400">IN DEV</span>}
                  </div>
                  ...
                  <p className="mt-2 min-h-[3.4em] flex-1 text-[13px] leading-[1.7] text-body">{p.tagline}</p>
                  <div className="mt-auto flex items-center gap-2 rounded-xl border border-accent/[0.1] bg-accent/[0.04] px-3.5 py-2.5">
