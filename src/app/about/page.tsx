      ...
      <div className="wrap">
        <div className="mx-auto max-w-[720px]">
          <Reveal>
            ...
            <h1 className="mt-5 font-display text-[clamp(32px,5vw,52px)] font-black leading-[1.05] tracking-[-0.04em] text-white">A studio built for<br />founders who ship</h1>
          </Reveal>
          ...
          <Reveal delay={0.15}>
            <h2 className="mb-8 mt-20 font-display text-[20px] font-bold tracking-[-0.02em] text-white">How we operate</h2>
          </Reveal>
              ...
              <Reveal key={v.title} delay={0.15 + i * 0.05}>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[13px] leading-[1.75] text-body">{v.desc}</p>
                  </div>
                </div>
              </Reveal>
            ))}
          ...
          <Reveal delay={0.3}>
            <div className="mt-16 rounded-2xl border border-white/[0.06] bg-white/[0.015] p-10 text-center" style={{ boxShadow: "0 1px 0 rgba(255,255,255,0.02) inset" }}>
              <h3 className="font-display text-[20px] font-bold tracking-[-0.02em] text-white">Ready to work with us?</h3>
              <p className="mt-2 text-[14px] text-body">Let&apos;s talk about your project.</p>
